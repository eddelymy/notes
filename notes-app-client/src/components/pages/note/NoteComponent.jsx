...
const NoteComponent = ({ _id,category, title, content }) => {
  ...
  return (
    <div className="flex flex-col rounded-2xl px-4 border-2 py-6 max-w-[800px] min-w-[300px] hover:-translate-y-1 hover:scale-10 duration-300" style={{ background: category.value }}>
      <div>
      <span 
      ...
      <div className="mt-6 h-full">
        ...
        <div 
          ref={contentRef}
          className={`mt-4 transition-all duration-300 ${isExpanded ? 'max-h-none' : 'max-h-[250px] overflow-hidden'}`}
        >
